            ...
            <div class="col-md-4">
                <form action="{{ route('crud.update', $crud->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-control-sm">
                        ...
                        <input type="email" class="form-control fs-5" name="email" value="{{ $crud->email }}"
                            id="" aria-describedby="helpId" placeholder="">
                        <small id="helpId" class="form-text text-muted"></small>
                    </div>
                    <div class="form-control-sm">
                        <label for="" class="form-label">Phone:</label>
                        <input type="number" class="form-control" name="phone" value="{{ $crud->phone }}"
                            id="" aria-describedby="helpId" placeholder="">
                        <small id="helpId" class="form-text text-muted"></small>
                    </div>
                    <div class="form-control-sm">
                    ...
                    <div class="form-control-sm">
                        ...
                        <input type="text" class="form-control" name="city" value="{{ $crud->city }}"
                            id="" aria-describedby="helpId" placeholder="">
                        <small id="helpId" class="form-text text-muted"></small>
                    </div>
                    <div class="form-control-sm">
